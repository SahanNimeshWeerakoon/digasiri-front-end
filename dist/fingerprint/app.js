...
function onClear() {
         ...
         vDiv.innerHTML = "";
         localStorage.setItem("fingerPrintImageSrc", "");
...
$("#save").on("click",function(){
    if(localStorage.getItem("fingerPrintImageSrc") == "" || localStorage.getItem("fingerPrintImageSrc") == null || document.getElementById('imagediv').innerHTML == ""){
        ...
        if(vDiv.children.length < 5){
            ...
            image.src = localStorage.getItem("fingerPrintImageSrc");
            vDiv.appendChild(image);

            localStorage.setItem("fingerPrintImageSrc"+vDiv.children.length,localStorage.getItem("fingerPrintImageSrc"));
        }else{
...
function sampleAcquired(s){
            if(currentFormat == Fingerprint.SampleFormat.PngImage){
                ...
                localStorage.setItem("fingerPrintImageSrc", "data:image/png;base64," + Fingerprint.b64UrlTo64(samples[0]));
                localStorage.setItem("intermediate", Fingerprint.SampleFormat.Intermediate);
    ...
    if(currentFormat == Fingerprint.SampleFormat.PngImage){
        if(localStorage.getItem("fingerPrintImageSrc") == "" || localStorage.getItem("fingerPrintImageSrc") == null || document.getElementById('imagediv').innerHTML == "" ){
           alert("No image to download");
            ...
            //alert(localStorage.getItem("fingerPrintImageSrc"));
            downloadURI(localStorage.getItem("fingerPrintImageSrc"), "sampleImage.png", "image/png");
        }
    }
